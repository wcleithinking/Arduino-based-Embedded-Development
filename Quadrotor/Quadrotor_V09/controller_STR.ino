...
#ifdef EEPROM_SAVE
    int eeAddress = 0;
    EEPROM.put(eeAddress, hata1);
    eeAddress += sizeof(float);
    EEPROM.put(eeAddress, hata2);
    eeAddress += sizeof(float);
    EEPROM.put(eeAddress, hata3);
    eeAddress += sizeof(float);
    EEPROM.put(eeAddress, hatb0);
    eeAddress += sizeof(float);
    EEPROM.put(eeAddress, hatb1);
    eeAddress += sizeof(float);
    EEPROM.put(eeAddress, hatb2);
#endif
    STR_YAW_flag = 0;
  }
}
