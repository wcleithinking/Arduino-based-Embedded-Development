...
double yaw_P[5][5] = {50, 0, 0, 0, 0, 0, 50, 0, 0, 0, 0, 0, 50, 0, 0, 0, 0, 0, 50, 0, 0, 0, 0, 0, 50};
...
void attitude_filter() {
  ...
  roll = hatroll * RadToDeg - roll_bias;
  pitch = hatpitch * RadToDeg - pitch_bias;
  yaw = hatyaw * RadToDeg - yaw_bias;
}
