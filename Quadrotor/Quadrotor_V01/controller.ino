void pid_controller(double kp, double ki, double kd) {
  ...
  */
  ...
  roll_feedforward      = 0;//map(pulse_value_1 - 1500, pulse_value_min - 1500, pulse_value_max - 1500, -100, 100);
  pitch_feedforward     = 0;//map(pulse_value_2 - 1500, pulse_value_min - 1500, pulse_value_max - 1500, -100, 100);
  altitude_feedforward  = map(pulse_value_3, pulse_value_min, pulse_value_max, pulse_value_min, pulse_value_max - 100);
  yaw_feedforward       = 0;//map(pulse_value_4 - 1500, pulse_value_min - 1500, pulse_value_max - 1500, -100, 100);
  /*
    feedback components
  */
